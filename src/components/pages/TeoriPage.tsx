      ...
      <div className="bg-base-100 pt-20">
        <div className="content-container px-4 flex justify-center flex-col items-center lg:px-0">
          ...
          <p className="text-center text-base-text pb-10 md:w-[80%]">
            Anda akan menemukan konsep teori dasar bina bicara yang esensial
            untuk mendukung pengembangan kemampuan bicara anak tunarungu.
            Informasi terperinci kami membantu orang tua memahami konsep penting
