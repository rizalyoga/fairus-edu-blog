...
const PretestVokalForm = () => {
  ...
  const confirmationHandler = () => {
    ...
    for (let i = 0; i < VokalPretestQuestions.length; i++) {
      if (userAnswers[i + 1] === VokalPretestQuestions[i].answer) {
        setScore((totalScore += VokalPretestQuestions[i].score));
      }
    }
  ...
  return (
    <>
      ...
      <div className="dashboard-content-container mb-4">
        ...
        {VokalPretestQuestions.map((question) => (
...
export default PretestVokalForm;
